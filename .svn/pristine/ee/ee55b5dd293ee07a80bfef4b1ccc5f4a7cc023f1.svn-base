...
/*
	...
	*//**
	 * product 저장 
	 *//*
	@RequestMapping("saveProductVue.do")
	@ResponseBody
	public Map<String, Object> saveProductVue(@RequestBody Map<String, Object> param) throws Exception {
	...
	*//**
	...
	public Map<String, Object> listComnDtlCodVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
		...
		paramMap.put("grp_cod", "FWCD");
		ComnGrpCodModel myModel = comnCodService.selectComnGrpCod(paramMap);
		
		
		
		Map<String, Object> resultMap = new HashMap<String, Object>();
		resultMap.put("listComnDtlCodModel", listComnDtlCodModel);
		resultMap.put("myItem", myModel);
	...
	@RequestMapping("saveComnGrpCodVue.do")
	//Map 형태 redirect안할때 씀 즉 값만 바꾸겠다.라는 이야기
	@ResponseBody
	public Map<String, Object> saveComnGrpCodVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		logger.info("   - paramMap : " + paramMap);
   ...
   *//**
   ...
   public Map<String,Object> groupDetailVue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
      ...
      // 공통 그룹코드 목록 조회
      List<ComnDtlCodModel> listComnGrpCodDtlModel = comnCodService.listComnDtlCod(paramMap);
      resultMap.put("listComnGrpCodDtlModel", listComnGrpCodDtlModel);

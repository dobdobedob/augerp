...
<script type="text/javascript">
	...
	/** 휴가일수 조회 */
	 function fListLoginVac() {
		/* callAjax("/employee/listLoginVac.do", "post", "text", true,); */
	} 
	...
	/** 그룹코드 모달 실행 */
	 function fPopModalEmpTaApply(grp_cod) {
		...
		<div id="container">
			<ul>
				...
				<li class="contents">
					...
					<div class="content">
						...
						<p class="Location">
							<a href="../dashboard/dashboard.do" class="btn_set home">메인으로</a> <span
								...
								관리</span> <a href="../employee/empTaApply.do" class="btn_set refresh">새로고침</a>
						</p>

						<p class="conTitle">
							<span>그룹 코드</span> <span class="fr"> <a
								class="btnType blue" href="javascript:fPopModalEmpTaApply();" name="modal"><span>신규등록</span></a>
							</span>
						</p>
					...
					<table width="100%" cellpadding="5" cellspacing="0" border="1"
					   ...
					   <tr>       
                           ...
                           &nbsp;&nbsp;&nbsp;
                           	근태종류 : <select id = "vactype" name = "vactype" style="width: 90px">
                           			</select>
                           	&nbsp;&nbsp;&nbsp;
				...
				<!-- <div class="btn_areaC mt30" style = "display:inline-block; float:right;"> -->
					...
					<a href="javascript:fPopModalEmpTaApply();" class="btnType blue" id="SaveBtnEmpTaApply" name="btn"><span>개인근태신청</span>
					</a></div>
				<!-- </div> -->
					...
					<%-- 	<table style="margin-top: 10px" width="100%" cellpadding="5" cellspacing="0" border="1"
                        ...
                        <tr style="border: 0px; border-color: blue">
                           ...
                           <td width="50" height="25" style="font-size: 100%; text-align:left; padding-right:25px;">
	                           ...
	                           <a href="" class="btnType blue" id="btnSearchEmpTaApply" name="btn"><span>검  색</span></a>
                           </td> 
						...
						<p class="conTitle mt50">
							<span>상세 코드</span> <span class="fr"> <a
								class="btnType blue"  href="javascript:fPopModalEmpDtlTaApply();" name="modal"><span>신규등록</span></a>
							</span>
						</p>
						...
						<div class="paging_area"  id="EmpDtlTaApplyPagination"> </div>
		...
		<dl>
			...
			<dd class="content">
				...
				<div class="btn_areaC mt30">
					<a href="" class="btnType blue" id="btnSaveEmpTaApply" name="btn"><span>저장</span></a> 
					<a href="" class="btnType blue" id="btnDeleteEmpTaApply" name="btn"><span>삭제</span></a> 
					<a href=""	class="btnType gray"  id="btnCloseEmpTaApply" name="btn"><span>취소</span></a>
				</div>
			</dd>
		</dl>
 	...
 	<div id="layer2" class="layerPop layerType2" style="width: 600px;">
		<dl>
			...
			<dd class="content">
				...
				<div class="btn_areaC mt30">
					<a href="" class="btnType blue" id="btnSaveEmpDtlTaApply" name="btn"><span>저장</span></a>

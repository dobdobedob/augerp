...
<script type="text/javascript">
	...
	// 상세코드 페이징 설정
	var pageSizeEmpDtlDv = 5;
	var pageBlockSizeEmpDtlDv = 10;
				...
				<ul>
					...
					<table width="100%" cellpadding="5" cellspacing="0" border="1"
                        ...
                        <tr style="border: 0px; border-color: blue" >
                          ...
                          <td> 신청일자 :<input type="date" style="width: 120px" id="from_date" name="from_date"> &nbsp;
                          	- 																					&nbsp;
                            <input type="date" style="width: 120px" id="to_date" name="to_date">
                           &nbsp;&nbsp;&nbsp;
                          			계정대분류명 : <select onchange = "showValue(this)" id = "vactype" style="width: 90px">
	                           			<option value = "승인">승인</option>
	                           			<option value = "승인대기">승인대기</option>
	                           			<option value = "반려">반려</option>
                           		   </select>
                           	&nbsp;&nbsp;&nbsp;
		                           	계정과목 : <select onchange = "showValue(this)" id = "vactype" style="width: 90px">
			                           			<option value = "승인">승인</option>
			                           			<option value = "승인대기">승인대기</option>
			                           			<option value = "반려">반려</option>
		                           		   </select>
                           ...
                           &nbsp;&nbsp;&nbsp;
                           		   ...
                           		   결재상태 : <select onchange = "showValue(this)" id = "vactype" style="width: 90px">
		                           			<option value = "승인">승인</option>
		                           			<option value = "승인대기">승인대기</option>
		                           			<option value = "반려">반려</option>
                           		 	  </select>
							...
							<%-- <table style="margin-top: 10px" width="100%" cellpadding="5"
								...
								<tr style="border: 0px; border-color: blue">
									...
									<td width="50" height="25"
										...
										class="btnType blue" id="btnSearchGrpcod" name="btn"><span>검
												색</span></a>
									</td>
					...
					<table class="row">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="inputTxt p100"
									id="dtl_cod_nm" name="dtl_cod_nm" /></td>
							</tr>

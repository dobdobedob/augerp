...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		$("#searchitemall").change(function() {
			selectCombo("searchitem", "searchitemall", "all", $("#searchitem").val(), "");
		});
		selectCombo("s", "sall", "all", $("#usercode").val(), "");
		selectCombo("a", "aall", "all", $("#achievementrate").val(), "");
		selectCombo("d", "dall", "all", $("#deptname").val(), "");
		selectCombo("u", "uall", "all", $("#username").val(), "");

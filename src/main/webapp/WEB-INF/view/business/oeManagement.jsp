 ...
 */	
	...
	function flistOeManagementResult(data, currentPage) {
		...
		//swal(paginationHtml);
		$("#comnOeManagementPagination").empty().append( paginationHtml );
				...
				<li class="contents">
					...
					<table width="100%" cellpadding="5" cellspacing="0" border="1"
                        ...
                        <tr style="border: 0px; border-color: blue">
                           ...
                           &nbsp;&nbsp;&nbsp;
                           	제품명 : <select onchange = "showValue(this)" id = "vactype" style="width: 70px">
	                           			<option value = "연차">연차</option>
	                           			<option value = "월차">월차</option>
	                           			<option value = "반차">반차</option>
                           			</select>
                           	&nbsp;&nbsp;&nbsp;
                           	거래처 : <select onchange = "showValue(this)" id = "vactype" style="width: 90px">
						...
						<div class="paging_area"  id="comnOeManagementPagination"> </div>
		...
		<dl>
			...
			<dd class="content">
				...
				<div class="btn_areaC mt30">
					<a href="" class="btnType blue" id="btnSaveOeManagement" name="btn"><span>저장</span></a> 
					<a href="" class="btnType blue" id="btnDeleteOeManagement" name="btn"><span>삭제</span></a> 
					<a href=""	class="btnType gray"  id="btnCloseOeManagement" name="btn"><span>취소</span></a>
				</div>
			</dd>
		</dl>

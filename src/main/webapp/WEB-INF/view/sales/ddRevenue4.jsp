...
<script type="text/javascript">
	...
	var ddrvenuelistcallback = function(returndata) {
		   ...
		   var lloop = 0;
			...
			var data = google.visualization.arrayToDataTable(returndatacallback.listCopItemOrder); 
			...
			hAxis: {title: "분류"},
			seriesType: "bars",
			series: {0: {type: "line"}} // vartical 축 기준으로 0번,1번,2번 타입 변경 할수 있음 ex > 1: {type: "line"}
			};
